...
import { getArticleImages, getRankingArticles, type Article } from "../api/articleApi";
...
const HotProductComponent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchArticles = async () => {
      try {
        const data = await getRankingArticles(today);
        setArticles(data);
  ...
  return (
    <div className="max-w-3xl mx-auto py-4">
      <h2 className="text-lg font-semibold mb-4">오늘의 핫템</h2>
      <Swiper
