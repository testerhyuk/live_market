...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2025, 3, 28, 0, 0);
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20250328");
        ...
        assertThat(hotArticleListRepository.readAll("20250328")).isEmpty();
    }
}